...
<html>
  <head>
    ...
    <div class="center page-header"><h3>スレッドの削除</h3></div>
   </head>
   <body>
   <div class="center">
    ...
    <div class="col-xs-6 col-md-4">
      <input type="text" class="form-control" id="update" value="<?php echo $_GET['thread_id'];?>">
    </div><br><br>
    <button type="submit"class="btn btn-lg btn-primary" id="submit">更新</button>
    <font color="red"><span id="update_alert"></span></font><br>
    <a href="http://192.168.33.12/BBS/index.php?url=thread">戻る</a>
   </div>
  </body>
</html>
